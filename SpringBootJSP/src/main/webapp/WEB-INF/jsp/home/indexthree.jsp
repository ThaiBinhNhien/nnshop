						...
						<ul class="main_menu">
							<li class="sale-noti">
								...
								<ul class="sub_menu">
									...
									<li class="sale-noti"><a href="home2">Homepage V3</a></li>
								</ul>
							</li>
...
<div class="container1-page">
		...
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1"
					style="background-image: url(images/master-slide-08.jpg);">
					<div
						class="wrap-content-slide1 size24 flex-col-c-m p-l-15 p-r-15 p-t-120 p-b-170">
						<h2
							class="caption1-slide1 xl-text3 t-center bo15 p-b-3 animated visible-false m-b-25"
							data-appear="fadeInUp">
							Flash Sale
						</h2>

						<span
							class="caption2-slide1 m-text27 t-center animated visible-false m-b-30"
	...
	<!-- Banner2 -->
	<div class="banner2 bg5 p-t-55 p-b-55 bg-img1"
			style="background-image: url(images/bg-banner-02.jpg);">
		<div class="container">
		...
		<div class="container">
			...
			<div class="tab01">
				...
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#best-seller"
						role="tab">Best Seller</a>
					</li>
					<li class="nav-item">
	...
	<footer class="bg6 p-t-45 p-b-43 p-l-65 p-r-65 p-lr-0-xl1">
		...
		<div class="t-center p-l-15 p-r-15">
			...
			<a href="#">
				<img class="h-size2" src="images/icons/mastercard.png"
				alt="IMG-MASTERCARD">
			</a>

			<a href="#">
				<img class="h-size2" src="images/icons/express.png"
				alt="IMG-EXPRESS">
			</a>

			<a href="#">
				<img class="h-size2" src="images/icons/discover.png"
				alt="IMG-DISCOVER">
			</a>
