...
<body class="animsition">
	...
	<div class="flex-c-m size22 bg0 s-text21 pos-relative">
		20% off everything! <a href="product.html" class="s-text22 hov6 p-l-5">
			Shop Now </a>
	...
	<!-- Header -->
	<header class="header2"> <!-- Header desktop -->
			...
			<div class="wrap_menu">
				...
				<ul class="main_menu">
					<li class="sale-noti"><a href="home">Home</a>
						<ul class="sub_menu">
							<li><a href="home">Homepage V1</a></li>
							<li class="sale-noti"><a href="home1">Homepage V2</a></li>
							<li><a href="home2">Homepage V3</a></li>
						</ul></li>
	...
	<div class="wrap-slick1">
		<div class="slick1">
			<div class="item-slick1 item1-slick1"
				style="background-image: url(images/master-slide-07.jpg);">
				<div
			...
			<div class="item-slick1 item2-slick1"
				style="background-image: url(images/master-slide-06.jpg);">
				<div
					class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
					<h2
						class="caption1-slide1 xl-text2 t-center bo14 p-b-6 animated visible-false m-b-22"
		...
		<div class="tab01">
			...
			<ul class="nav nav-tabs" role="tablist">
				...
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#featured" role="tab">Featured</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#sale" role="tab">Sale</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#top-rate" role="tab">Top Rate</a></li>
			</ul>
	...
	<section class="parallax0 parallax100"
		style="background-image: url(images/bg-video-01.jpg);">
