		...
		<div class="wrap_header">
			...
			<div class="wrap_menu">
				...
				<ul class="main_menu">
					...
					<li class="sale-noti"><a href="blog">Blog</a></li>
				...
				<div class="p-r-50 p-r-0-lg">
					...
					<div class="item-blog p-b-80">
						...
						<div class="item-blog-txt p-t-33">
							<h4 class="p-b-11">
								<a href="blog-detail" class="m-text24"> Black Friday
							...
							<a href="blog-detail" class="s-text20"> Continue Reading
					...
					<div class="item-blog p-b-80">
						...
						<div class="item-blog-txt p-t-33">
							<h4 class="p-b-11">
								<a href="blog-detail" class="m-text24"> The White
