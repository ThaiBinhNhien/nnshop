		...
		<div class="wrap_header">
			...
			<div class="wrap_menu">
				...
				<ul class="main_menu">
					...
					<li class="sale-noti"><a href="product.html">Shop</a></li>
		...
		<div class="row">
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
				<div class="leftbar p-r-20 p-r-0-sm">
					...
					<ul class="p-b-54">
						<li class="p-t-4"><a href="../shop" class="s-text13 active1">
								All </a></li>
						<c:forEach items="${lstCategory}" var="item">
							<li class="p-t-4"><a href="../shop/${item.idCategory}"
								class="s-text13"><c:out value="${item.nameCategory}" /> </a></li>
						</c:forEach>
					</ul>
			...
			<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
				...
				<div class="flex-sb-m flex-w p-b-35">
					...
					<span class="s-text8 p-t-5 p-b-5"> Showing 12 of 16 results
					</span>
				</div>
